...
EXAMPLES = [
    dict(path="example-posts/01-design-note-portrait.png", size_name="portrait",
         eyebrow="Design Notes", layout="left",
         headline_lines=["Let the", "room", "breathe."],
         subline="Space is the quietest luxury.", seed=11),
    dict(path="example-posts/02-brand-story-square.png", size_name="square",
         eyebrow="The Westbury Way", layout="center", divider=True, seed=23,
         headline_lines=["Crafted for the", "way you live."],
         subline="Considered pieces. Timeless rooms."),
    dict(path="example-posts/03-autumn-landscape.png", size_name="landscape",
